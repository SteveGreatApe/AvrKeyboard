...
// Removed by Great Ape as not required and can avoid pulling in SettingsValues dependency
...
//
    public static int getDefaultKeyboardHeight(final Resources res) {
        final DisplayMetrics dm = res.getDisplayMetrics();
        // Great Ape change, simplified to avoid pulling in extra resources
