 ...
 */
public class TextFieldStyleSolid extends TextFieldStyle {
    private static final int MainTextColor = 0xFF00CCFF;
    ...
    private static final float BUTTON_SIZE = TEXT_HEIGHT;
    private static final float BUTTON_MARGIN = 0.2f;

    public TextFieldStyleSolid() {
        space_drawable = R.drawable.avrk_text_field_space;
        space_width = 0.5f;
        space_height = 0.04f;

        KeyStyle keyStyle = new KeyStyle();
        keyStyle.background.drawable = R.drawable.avrk_text_field_button_solid;
        ...
        keyStyle.text_color = MainTextColor;
        ...
        cursor_color = 0xC000CCFF;
        cursor_flash_on_time = 0.6f;
        cursor_flash_off_time = 0.4f;

        textStyle.text_color = MainTextColor;
